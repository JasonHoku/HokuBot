            ...
            if (splittedMessage[0].includes("!tts")) {
              if (splittedMessage[1]) {
                ...
                db.collection("Public")
                  ...
                  .get()
                  .then((doc) => {
                    gotTTSString = JSON.parse(JSON.stringify(doc.data()))
                      .TTSString;
              ...
              .then((doc) => {
                ...
                if (splittedMessage[1] === "fin") {
                  ...
                  if (String(listArray).length > 450) {
                    ...
                    splittedTextOverflowArray.push(
                      String(listArray).substring(0, 450)
                    );
                    splittedTextOverflowArray.push(
                      String(listArray).substring(450)
                    );
          ...
          twitchDecaHourlyChatSendVar = setInterval(() => {
            ...
            db.collection("Public")
              ...
              .then((snapshot) => {
                ...
                console.log(
                  "|T| Running Announcement " + chatClient.isConnected
                );
              });
          }, 1000 * 60 * 10);
        }
